...
# dizionario per contenere gli stati di animazione
var states = {
...
#dizionario per mantenere le velocità a cui vogliamo riprodurre le animazioni
...
var current_state = null #variabile per contenere il nome dello stato dell'animazione in cui ci troviamo attualmente
var callback_function = null #variabile per contenere la funzione di callback
